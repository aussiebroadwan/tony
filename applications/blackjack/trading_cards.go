...
var VeteranPlayerCard = tradingcards.Card{
	...
	Description: "Issued to those who have played over 100 games, this card honors your dedication and long-standing participation.",
...
var BlackjackStreakCard = tradingcards.Card{
	...
	Description: "Earn this card by hitting three consecutive blackjacks in one session, a testament to your skill and good fortune.",
...
var HighRollerCard = tradingcards.Card{
	...
	Application: applicationId,
	Title:       "High Roller",
	Description: "This card celebrates your achievement of accumulating over 1,000 credits in winnings, distinguishing you as one of the elite players.",
...
var Perfect21Card = tradingcards.Card{
	...
	Application: applicationId,
	Title:       "Perfect 21",
	Description: "A legendary card for those skilled enough to achieve a perfect 21 total ten times, showcasing your expert level of luck.",
